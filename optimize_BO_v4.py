...
def calculate_rmse(sim_dist: dict, exp_dist: dict, max_length: int = 5) -> float:
    weights = np.array([
        1.0 if c <= 4 else 
        1.0 if c <= 12 else
        1.0
...
def optimize_parameters(
    ...
    space = [
        Real(1e-4, 1e-3,  name='k_ads_i'),
        Real(5e-5, 5e-4,  name='k_ads_t'),
        Real(1e-2, 5e-1,  name='k_d_i'),
        Real(1e-2, 3e-1,  name='k_d_t'),

        Real(0.001, 0.1, name='alpha_vdw_gas'),
        Real(0.001, 0.05, name='alpha_vdw_light'),
        Real(0.001, 0.05, name='alpha_vdw_heavy'),

        Real(1e-3, 1e-2,  name='k_dMC_i'),
        Real(5e-3, 5e-2,  name='k_dMC_t'),
        Real(1e-4, 1e-3,  name='k_crk_i'),
        Real(2e-3, 2e-2,  name='k_crk_t'),
